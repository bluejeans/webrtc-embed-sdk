...
import { ViewContainer, GreetingsHeader, GreetingsSubHeader, MeetingInfoContainer, MeetingID, Passcode, JoinName, JoinButton,
    UIOptionsContainer, UIOptions, OptionsWrapper, OptionsHeader, OptionsData, CheckBox, InputBox, BGOptionContainer, BGColorTextLabel, BGColorTextBox, BGColorHint,
    IFramePropsContainer, IFrameLabel, IFrameProps, PropsSpecs, PropsHint, THWorkFlow, Circle, SubLabel, LabelContainer, THResourceContainer, THResourceForm,
    THResourceJsonSection, MeetingDeviceDropdown, Arrow, THOptionsHeader, THOptionsWrapper } from './styles/PreMeeting';
...
export default class PreMeetingView extends Component<Props> {
    ...
    render() {
        const thArticlesCount = this.viewmodel.teleHealthConfig.resources?.articles?.data?.length || 0;
        const thVideosCount = this.viewmodel.teleHealthConfig.resources?.videos?.data?.length || 0;
        return (
            <ViewContainer>
                ...
                <MeetingInfoContainer>
                    ...
                    <>
                        ...
                        <>
                            <OptionsWrapper>
                                <OptionsHeader>Theme selection (*Optional, will be ignored if Telehealth PLE customisations are set)</OptionsHeader>
                            </OptionsWrapper>
                    ...
                    <THOptionsWrapper onClick={this.viewmodel.toggleShowTHCustomisationOptions}>
                        <Arrow closed={!this.viewmodel.showTHCustomisationOptions}/>
                        <THOptionsHeader>TeleHealth PLE customisation (Optional)</THOptionsHeader>
                    </THOptionsWrapper>
                    ...
                    { this.viewmodel.showTHCustomisationOptions && <>
                        <UIOptionsContainer>
                                ...
                                <tr>
                                    <OptionsData>
                                        { this.viewmodel.isMobileEmbed ? (
                                            <>
                                                <LabelContainer>
                                                    <label>Logo URL (Image must be transparent): </label>
                                            ...
                                            <>
                                                ...
                                                <>
                                                    <LabelContainer>
                                                        <label>White Logo URL (Image must be transparent): </label>
                                                        <SubLabel> *Visible only on landing screen</SubLabel>
                                                    </LabelContainer>
                                                    <InputBox
                                                        type="text"
                                    ...
                                    <OptionsData>
                                        <>
                                            <LabelContainer>
                                                ...
                                                <SubLabel> *Custom background for entire entire app in televisit</SubLabel>
                                            </LabelContainer>
                                            <InputBox
                                                type="text"
                                                placeholder="#FFFFFF or linear-gradient(#6600CC, #6600FF)"
                            ...
                            <THResourceContainer>
                                <fieldset>
                                    <legend><b>Article</b></legend>
                                    <THResourceForm onSubmit={this.viewmodel.addTelehealthArticle}>
                                        <div>
                                ...
                                <fieldset>
                                    ...
                                    <THResourceForm onSubmit={this.viewmodel.addTelehealthVideo}>
                                        <div>
                                            <label htmlFor="title">Title: </label>
                                            <InputBox
                                                name="title"
                        ...
                        <THResourceJsonSection style={{textAlign: 'initial'}}>
                            <summary>TeleHealth resources ( {`Videos : ${thVideosCount} | Articles : ${thArticlesCount}`} )</summary>
                            <pre >
                                {JSON.stringify(toJS(this.viewmodel.teleHealthConfig.resources), undefined, 2)}
                            </pre>
